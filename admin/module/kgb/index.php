                    ...
                    <tbody>
                        ...
                        ?>
                            <div class="alert alert-success alert-dismissable">
                                <p>Tidak ada pegawai yang mendapatkan kenaikan gaji berkala sampai dengan tanggal <span style="font-weight:bold;color:yellow;"><?= date('d-m-Y'); ?></span> Silahkan <a href="?module">kembali</a></p>
                            </div>
                        <?php
                        } else { ?>
                            <div class="row">
                                                                ...
                                                                <div class="container-fluid">
                                                                    <div class="col-md-12">
                                                                        <b>1.&ensp;</b><span>Pastikan Data KGB terakhir sesuai dengan SK KGB terakhir agar tidak terjadi kesalahan pencetakan<br>
                                                                            ...
                                                                            <b>3.&ensp;</b>Jika sudah dapat di pastikan benar maka silahkan <b>Download Surat</b> Kenaikan Gaji Berkala<br>
                                                                            <b>4.&ensp;</b>Kemudian <b><span style="color: red;">Diharuskan </span>Upload</b> Hasil <b>Download</b> tersebut di halaman <b>Upload</b></span><br>
                                                                        <span><b>5.&ensp;</b>Jika Anda Tidak <b>Upload</b> Surat tersebut, maka data KGB tidak akan di perbaharui dan KGB selanjutnya akan terjadi kesalahan</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <a type="submit" target="_blank" href="cetak_gaji.php?nip=<?php echo $row1['nip']; ?>" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> Download Surat</a>
                                                            </div>
                                                            </form>
                                                        </div>
                                                    </div>
