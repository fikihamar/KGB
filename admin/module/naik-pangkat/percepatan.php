...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Percepatan Promosi Pangkat</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="?module=dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Percepatan Promosi Pangkat</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <table id="table-data" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                while ($p = mysqli_fetch_array($data)) {
                                    $penundaan = $p['penundaan_kenaikan'];
                                    if ($penundaan == 0) {
                                ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            ...
                                            <td><?= $p['percepatan_kenaikan']; ?> tahun</td>
